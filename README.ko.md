...
curl -fsSL https://raw.githubusercontent.com/agentlas-ai/Hephaestus/v0.7.7/scripts/install-all-runtimes.sh | bash
...
```bash
codex plugin marketplace add agentlas-ai/Hephaestus --ref v0.7.7
...
```bash
curl -fsSL https://raw.githubusercontent.com/agentlas-ai/Hephaestus/v0.7.7/scripts/install.sh | bash
...
```powershell
$zip = "$env:TEMP\hephaestus-v0.7.7.zip"
$extract = "$env:TEMP\hephaestus-v0.7.7"
Invoke-WebRequest "https://github.com/agentlas-ai/Hephaestus/archive/refs/tags/v0.7.7.zip" -OutFile $zip
