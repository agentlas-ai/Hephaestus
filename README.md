...
From your OS terminal:
```bash
codex plugin marketplace add agentlas-ai/Agentlas-OS --ref v1.1.43
...
The v1.1.43 release contract ships and verifies a dependency-free
...
The v1.1.43 self-updater installs the complete one-touch runtime payload,
