...
[Agentlas Desktop](https://agentlas.cloud/desktop) 是这套 Agent OS 的图形外壳——同样的内核、调度器与治理子系统，以可视化方式操作。Desktop 0.6.0 内置并锁定 Hephaestus v1.1.6 引擎；应用与其内核版本互相锁定，作为一个整体自动更新。
